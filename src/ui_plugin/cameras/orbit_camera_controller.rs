...
use super::orbit_camera::{ScrollOrbitCameraAction, OrbitCameraState, OrbitCameraSettings};


///System for handling controls that effect the camera.
pub fn orbit_camera_system(
    ...
    for (settings, mut state, mut transform) in &mut q_camera {
        ...
        if settings.scroll_action == Some(ScrollOrbitCameraAction::Pan) {
        ...
        if settings.scroll_action == Some(ScrollOrbitCameraAction::Orbit) {
        ...
        if settings.scroll_action == Some(ScrollOrbitCameraAction::Zoom) {
